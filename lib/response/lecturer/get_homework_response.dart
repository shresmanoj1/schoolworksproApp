...
//
//     final getHomeworkResponse = getHomeworkResponseFromJson(jsonString);

import 'dart:convert';

GetHomeworkResponse getHomeworkResponseFromJson(String str) =>
    GetHomeworkResponse.fromJson(json.decode(str));

String getHomeworkResponseToJson(GetHomeworkResponse data) =>
