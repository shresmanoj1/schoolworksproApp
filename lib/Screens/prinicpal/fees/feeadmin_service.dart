...
class FeeServiceAdmin {
  Future<Addprojectresponse> transactiondatastart(
      FeeAdminRequest request) async {
    final SharedPreferences sharedPreferences =
    await SharedPreferences.getInstance();

    String? token = sharedPreferences.getString('token');

    print(api_url2 + 'fees/get-my-financial-data-start');
    try {
      return await http
  ...
  Future<Addprojectresponse> duedatastart(FeeAdminRequest request) async {
    final SharedPreferences sharedPreferences =
    await SharedPreferences.getInstance();
    ...
    try {
      return await http
          ...
          .then((data) {
        if (data.statusCode == 200) {
          print(api_url2 + 'fees/get-my-financial-due-data-start');
  ...
  Future<GetFeesResponse> duedatafinish(FeeAdminRequest request) async {
    final SharedPreferences sharedPreferences =
    await SharedPreferences.getInstance();

    String? token = sharedPreferences.getString('token');

    print(api_url2 + 'fees/get-my-financial-due-data-finish');
    try {
      return await http
